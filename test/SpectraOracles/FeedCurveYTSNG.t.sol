...
import {MockPriceFeedCurveYTAssetSNG} from "./mocks/stableswap-ng/MockPriceFeedCurveYTAssetSNG.sol";
import {MockPriceFeedCurveYTIBTSNG} from "./mocks/stableswap-ng/MockPriceFeedCurveYTIBTSNG.sol";
import {IPrincipalToken} from "../../src/interfaces/IPrincipalToken.sol";

contract FeedCurveYTTest is BaseSpectraFeedSNGTest {
    ...
    function test_description() public override {
        ...
        _priceFeedInAsset_ = address(new MockPriceFeedCurveYTAssetSNG(_pt_, _curvePool_));
        _priceFeedInIBT_ = address(new MockPriceFeedCurveYTIBTSNG(_pt_, _curvePool_));
        assertEq(
    ...
    function test_latestRoundData_fuzz(
        ...
        uint256 ptToIBTRateOracle = ibtUnit.mulDiv(
            _rate_adjusted_price_oracle(_curvePool_),
