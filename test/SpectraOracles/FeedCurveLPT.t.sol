...
import {MockPriceFeedCurvePTIBT} from "./mocks/cryptoswap-ng/MockPriceFeedCurvePTIBT.sol";
import {MockPriceFeedCurveLPTAsset} from "./mocks/cryptoswap-ng/MockPriceFeedCurveLPTAsset.sol";
import {MockPriceFeedCurveLPTIBT} from "./mocks/cryptoswap-ng/MockPriceFeedCurveLPTIBT.sol";
import {IPrincipalToken} from "../../src/interfaces/IPrincipalToken.sol";

contract FeedCurveLPTTest is BaseSpectraFeedTest {
    ...
    function test_description() public override {
        ...
        _priceFeedInAsset_ = address(new MockPriceFeedCurveLPTAsset(_pt_, _curvePool_));
        _priceFeedInIBT_ = address(new MockPriceFeedCurveLPTIBT(_pt_, _curvePool_));
        assertEq(
    ...
    function test_getRoundDataAsset_basic_fuzz(Init memory init, uint80 _roundId) public override {
        ...
        uint256 poolBalIBT = ICurveNGPool(_curvePool_).balances(0);
        uint256 poolBalPT = ICurveNGPool(_curvePool_).balances(1);
