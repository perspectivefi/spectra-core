...
import "../../src/mocks/MockIBTCustomDepositFeesThreshold.sol";

contract MockIBTDepositFeesTests is MockIBTFees {
    function _deployProtocol(
        ...
        ibt = address(
            new MockIBTCustomDepositFeesThreshold(
                "MOCK IBT",
                "MIBT",
                IERC20(_underlying_),
                _ibtDecimals,
        ...
        MockIBTCustomDepositFeesThreshold(ibt).deposit(ASSET_UNIT, address(this));
