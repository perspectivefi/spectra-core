...
contract PTViews {
    ...
    uint256 internal constant IBT_UNIT = 1e18;
     ...
     */
    function convertPTSharesToIBTsWithRate(
        uint256 shares,
        uint256 _ptRate,
        uint256 _ibtRate,
        bool roundUp
    ) public pure returns (uint256 ibts) {
        if (_ibtRate == 0) {
            revert();
        }
     ...
     */
    function convertIBTsToPTsSharesWithRate(
        uint256 ibts,
        uint256 _ptRate,
        uint256 _ibtRate,
        bool roundUp
...
contract ContractPrincipalToken1 is Test {
    ...
    address public curveFactoryAddress = 0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F;
    ...
    function testDoubleDepositIBTWithBothPAndNYield() public {
        ...
        assertApproxEqAbs(
            principalToken.balanceOf(testUser),
            ptBalance +
                views.convertToSharesWithRate(
                    views.convertToAssetsWithRate(
                        amountToDeposit,
                        oldIBTRate,
                        false,
                        true,
    ...
    function testClaimFees() public {
        ...
        uint256 expectedUnclaimedFeesInIBT = views
            .convertPTSharesToIBTsWithRate(receivedShares, _ptRate, _ibtRate, false)
    ...
    function testDepositIBTFailsZeroRate() public {
        uint256 amountOfIbtToDeposit = 1e18;
        _prepareForDepositIBT(testUser, amountOfIbtToDeposit);
        uint256 amountInUnderlying = ibt.convertToAssets(amountOfIbtToDeposit);
        uint256 ptMintedByFuture = _testDepositIBT(amountOfIbtToDeposit, testUser);
        ...
        // preview should revert due to null rate
        bytes memory revertData = abi.encodeWithSelector(
            bytes4(keccak256("RateError()"))
        );
        vm.expectRevert(revertData);
        principalToken.previewDeposit(amountOfIbtToDeposit);

        // deposit should fail due to null rate
        _prepareForDepositIBT(testUser, amountOfIbtToDeposit);
        vm.prank(testUser);
        ibt.approve(address(principalToken), amountOfIbtToDeposit);
        vm.expectRevert();
    ...
    function testBurn() public {
        ...
        uint256 IBTLostThroughPTAsCollateralPerYT = views.convertToSharesWithRate(
            views.convertToAssetsWithRate(
                yt.actualBalanceOf(address(this)),
                (oldPTRate - newPTRate),
                false,
    ...
    function testClaimYieldWithMultipleRateChanges() public {
        ...
        yieldData.expectedYieldInIBTUser1 = views
            .convertPTSharesToIBTsWithRate(
                yt.actualBalanceOf(MOCK_ADDR_1).toRay(18),
                rateData.oldPTRate,
                rateData.oldIBTRate,
                false
            )
            .mulDiv((rateData.newIBTRate - rateData.oldIBTRate), rateData.newIBTRate)
            .fromRay(18);
        ...
        if (rateData.newIBTRate > rateData.rateIBT0) {
            // more positive yield
            assetLostThroughDepegForYTUser1 = views.convertToAssetsWithRate(
            ...
            yieldData.yieldInUnderlyingUser1 = views.convertToAssetsWithRate(
                views.convertPTSharesToIBTsWithRate(
                    yt.actualBalanceOf(MOCK_ADDR_1).toRay(18),
                    rateData.ratePT0,
                    rateData.rateIBT0,
                    false
            ...
            yieldData.expectedYieldInIBTUser1 = views.convertToSharesWithRate(
        ...
        uint256 underlyingLostThroughDepegForYTUser1 = views.convertToAssetsWithRate(
            yt.actualBalanceOf(MOCK_ADDR_1),
        ...
        uint256 underlyingLostThroughDepegForYTUser2 = views.convertToAssetsWithRate(
        ...
        yieldData.yieldInUnderlyingUser2 = views.convertToAssetsWithRate(
            views.convertPTSharesToIBTsWithRate(
        ...
        yieldData.expectedYieldInIBTUser2 = views.convertToSharesWithRate(
        ...
        underlyingLostThroughDepegForYTUser1 = views.convertToAssetsWithRate(
            yt.actualBalanceOf(MOCK_ADDR_1),
            (rateData.oldPTRate - rateData.newPTRate),
            false,
            true,
        ...
        underlyingLostThroughDepegForYTUser2 = views.convertToAssetsWithRate(
            yt.actualBalanceOf(MOCK_ADDR_2),
            (rateData.oldPTRate - rateData.newPTRate),
            false,
            true,
    ...
    function testClaimPositiveYieldOfAmount() public {
        ...
        yieldData.expectedYieldInIBTUser2 = views
            .convertPTSharesToIBTsWithRate(
                yt.actualBalanceOf(MOCK_ADDR_2).toRay(18),
                rateData.oldPTRate,
                rateData.oldIBTRate,
        ...
        yieldData.expectedYieldInIBTUser3 = views
            .convertPTSharesToIBTsWithRate(
        ...
        yieldData.expectedYieldInIBTUser4 = views
            .convertPTSharesToIBTsWithRate(
    ...
    function testPreviewRedeemFuzz2(uint256 amount, uint16 _rate) public {
        ...
        uint256 ptInIBTAtExpiry = views.convertPTSharesToIBTsWithRate(
            amount,
            ptRateAtExpiry,
            ibtRateAtExpiry,
            false
    ...
    function testRedeem12Fuzz(
        ...
        uint256 ptRateAtExpiry = principalToken.getPTRate();
        uint256 ibtRateAtExpiry = principalToken.getIBTRate();
        uint256 ptInIBTAtExpiry1 = views.convertPTSharesToIBTsWithRate(
            shares1,
            ptRateAtExpiry,
            ibtRateAtExpiry,
            false
        );
        uint256 ptInIBTAtExpiry2 = views.convertPTSharesToIBTsWithRate(
            shares2,
            ptRateAtExpiry,
            ibtRateAtExpiry,
            false
        );
        uint256 ptInIBTAtExpiry3 = views.convertPTSharesToIBTsWithRate(
            shares3,
            ptRateAtExpiry,
            ibtRateAtExpiry,
            false
    ...
    function testPreviewWithdrawFuzz(uint256 amount, uint16 _rate) public {
        ...
        uint256 expectedShares = views.convertToSharesWithRate(
            amount,
            ptRate,
            false,
            false,
        ...
        uint256 expectedShares2 = views.convertToSharesWithRate(
            amount,
            ptRate,
            false,
            false,
    ...
    function _testDeposit(uint256 amount, address receiver) internal returns (uint256 shares) {
        ...
        if (data.preview == 0) {
            ...
            assertApproxEqAbs(
                data.preview,
                views.convertIBTsToPTsSharesWithRate(
    ...
    function _testYieldUpdate(
    ...
    ) public returns (UserRate memory updatedData) {
        uint256 userYTBalanceInRay = yt.actualBalanceOf(user).toRay(18);
        uint256 yieldInUnderlyingRay;
        uint256 underlyingOfYTRay = views.convertToAssetsWithRate(
            userYTBalanceInRay,
            data.oldPTRate,
            true,
            true,
        ...
        uint256 ibtOfYTInRay = views.convertToSharesWithRate(
            underlyingOfYTRay,
            data.oldIBTRate,
            true,
            true,
        ...
        if (newPtRate == data.oldPTRate && newIbtrate == data.oldIBTRate) {
            ...
            yieldInUnderlyingRay = views.convertToAssetsWithRate(
                ibtOfYTInRay,
            ...
            if (data.oldPTRate > newPtRate) {
                if (newIbtrate > data.oldIBTRate) {
                    ...
                    uint256 actualNegativeYieldInUnderlyingRay = views.convertToAssetsWithRate(
                        userYTBalanceInRay,
                        (data.oldPTRate - newPtRate),
                        true,
                        true,
                    ...
                    uint256 expectedNegativeYieldInUnderlyingRay = views.convertToAssetsWithRate(
                        ibtOfYTInRay,
        ...
        uint256 yieldInIBT = views.convertToSharesWithRate(
            yieldInUnderlyingRay,
            newIbtrate,
            true,
            false,
