...
contract MockRewardsProxy is IRewardsProxy {
    /**
     * @notice Claim rewards from the rewards contract
     * @param data The data to be passed to the rewards contract
     * @dev The data should be the encoded function call to the rewards contract
     * @dev Only callable by the rewards distributor contract
     */
