...
/**
 * @title BaseFeedCurveYTAsset contract
 * @author Spectra Finance
 * @notice Base contract to implement the AggregatorV3Interface feed for the YT price expressed in asset
 */
abstract contract BaseFeedCurveYTAssetSNG is BaseOracleCurveYT {
    ...
    function _YTPrice() internal view override returns (uint256) {
        return CurveOracleLib.getYTToAssetRateSNG(pool);
    }
